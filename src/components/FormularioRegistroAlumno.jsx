...
const FormularioRegistroAlumno = () => {
  ...
  const registrarAlumno = async (e) => {
    ...
    try {
      ...
      if (fotoArchivo && userIdParaRollback) {
        ...
        if (!upError) {
          publicUrlFinal = supabase.storage
            .from('Fotos_Alumnos')
      ...
      await registrarLog({
        ...
        detalles: {
          categoria: datosAInsertar.categoria,
          documento: datosAInsertar.numero_documento
        }
      });
  ...
  }; // <- cierre correcto de registrarAlumno
        ...
        <div className="xl:col-span-4 space-y-6">
          <section className="bg-slate-900/40 border border-white/10 rounded-[2rem] p-6 text-center">
            <div
              ...
              className="w-40 h-48 mx-auto bg-slate-800 border-2 border-dashed border-white/10 rounded-2xl flex items-center justify-center cursor-pointer overflow-hidden group hover:border-primary/50 transition-all"
            >
              {fotoPreview
        ...
        <div className="xl:col-span-8 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  required
                  className="w-full bg-slate-800 border-none rounded-xl p-3 text-white text-xs outline-none focus:ring-1 ring-primary [color-scheme:dark]"
                />
              </div>
              <div className="space-y-1">
              ...
              <Input
                ...
                value={contacto1}
                onChange={(e) => handlePhoneChange(e, setContacto1)}
                required
              />
            </div>
          </div>
          ...
          <div className="bg-slate-900/40 border border-white/10 rounded-[2rem] p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Input
                ...
                value={contacto2}
                onChange={(e) => handlePhoneChange(e, setContacto2)}
                required
              />
            </div>
          </div>
          ...
          <div className="bg-slate-900/40 border border-white/10 rounded-[2rem] p-8 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="md:col-span-2">
              <Select name="eps" label="EPS del Alumno" options={EPS_COLOMBIA} required />
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                className="w-full bg-slate-800 rounded-xl p-4 text-white text-xs h-20 outline-none focus:ring-1 ring-primary resize-none"
                placeholder="Escriba aquí si el alumno padece alguna condición..."
              ></textarea>
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-primary py-5 rounded-2xl text-black font-black uppercase tracking-[0.4em] text-[10px] hover:bg-white hover:scale-[1.01] transition-all disabled:opacity-50 flex items-center justify-center gap-3"
          >
            {loading ? (
              <>
...
const Select = ({ label, name, options, required, value, onChange }) => (
  <div className="flex flex-col gap-1">
    ...
    <select
      ...
      value={value}
      onChange={onChange}
      className="bg-slate-800 border-none rounded-xl p-3 text-white text-xs outline-none focus:ring-1 ring-primary"
    >
