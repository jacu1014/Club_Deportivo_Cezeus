  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-8 animate-in fade-in duration-700 pb-20 px-4 mt-4 text-slate-200">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        {canManage && (
          <button 
            ...
            className="bg-cyan-400 text-[#0a1118] text-[10px] font-black px-8 py-4 rounded-2xl uppercase transition-all hover:scale-105 shadow-lg shadow-cyan-500/20 flex items-center gap-2"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-3 bg-[#0a0f18]/60 border border-white/10 rounded-[2.5rem] p-8 shadow-2xl backdrop-blur-md relative overflow-hidden">
        ...
        <div className="space-y-6">
          ...
          {/* PRÓXIMOS EN AGENDA CON LÓGICA DE EDAD PARA ALUMNOS */}
